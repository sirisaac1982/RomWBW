...
#IF ((PLATFORM == PLT_SBC) | (PLATFORM == PLT_ZETA))
	...
	RET				; DONE
#ENDIF
#IF ((PLATFORM == PLT_ZETA2) | (PLATFORM == PLT_SMB))
...
#ENDIF
#IF (ACIAENABLE)
INT_ACIA:	; ACIA INTERRUPT HANDLER
        ; note: assumes HL is already pushed by caller
	LD	HL, ACIA_INT_HDLR
	JR	HBX_INT
#ENDIF
;
...
#IF (SMB_Z180)
        ; This is almost the same as PLT_N8 / PLT_MK4 -- maybe consolidate them
...
ORG_VFDTERM  	.EQU	$
  #INCLUDE "vfd.asm"
SIZ_VFDTERM 	.EQU	$ - ORG_VFDTERM
		.ECHO	"VFDTERM occupies "
		.ECHO	SIZ_VFDTERM
		.ECHO	" bytes.\n"
#ENDIF
...
HB_WAITSEC1:
#IF ((PLATFORM == PLT_SBC) | (PLATFORM == PLT_ZETA) | (PLATFORM == PLT_ZETA2) | (PLATFORM == PLT_SMB))
        ; XXX revisit
...
PS_SDSTRREF:
	...
	.DW	PS_SDPRPCON, PS_SDPPPCON, PS_SIO, PS_ACIA
;
PS_SDUART		.TEXT	"UART$"
PS_SDASCI		.TEXT	"ASCI$"
PS_SDTERM		.TEXT	"TERM$"
