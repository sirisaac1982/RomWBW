...
FDMODE_SMB_FD   .EQU 7               ; smbaker - rc2014 - fdc9266
FDMODE_SMB_WD   .EQU 8               ; smbaker - rc2014 - wd37c65
;
; IDE MODE SELECTIONS
;
IDEMODE_NONE	.EQU	0
...
#ENDIF
#IF (PLATFORM == PLT_SMB)
  #DEFINE	PLATFORM_NAME	"SMBAKER-RC2014"
#ENDIF
;
...
#DEFINE    VPRTC_NC(C) LD A, C \ OUT (VFD_D),A

#DEFINE    VPRTC(C) CALL VPRTCH \ .DB C
