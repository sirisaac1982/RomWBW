...
INTTYPE         .EQU    IT_CTC          ; INTERRUPT HANDLING TYPE (IT_NONE, IT_SIMH, IT_Z180, IT_CTC, ...)
;
...
FDMODE          .EQU    FDMODE_SMB_WD   ; FDMODE_DIO, FDMODE_ZETA, FDMODE_DIDE, FDMODE_N8, FDMODE_DIO3
